...
/* harmony import */ var _zeitiger_elevatezoom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(402);
/* harmony import */ var _zeitiger_elevatezoom__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_zeitiger_elevatezoom__WEBPACK_IMPORTED_MODULE_1__);
...
$(document).ready(function () {
  ...
  $(".zoom-slider-img").click(function (e) {
    $(".zoom-slider").find('img.active').removeClass('active');
    var activeImg = $(e.target).attr('src');
    console.log(activeImg);
    $(".zoom-slider img").each(function ($i, $img) {
  ...
  $('.zoom-img-icon').click(function () {
    var activeImg = $(".zoom-slider").find('img.active').attr('src');
  ...
  $('.zoom-slider-container .slick-arrow').click(function () {
    $(".zoom-slider").find('.active').removeClass('active');
    $('.slick-current img').addClass('active');
    var activeImg = $(".zoom-slider").find('.active').attr('src');
    $('.zoom-slider-container .zoom-img-lg').attr('src', activeImg);
  });
  /*footer tagovi */
  ...
  $(".tag-item").click(function (e) {
    ...
    $(e.target).addClass('active'); //ako više tagova može biti aktivno u isto vrijeme:
  ...
  $('.tabs-list li').click(function (e) {
    ...
    $('.tabs-list li').each(function (i, li) {
      if (li == e.target) {
        e.target.classList.add('active');
        activeTab = "#tab-" + (i + 1); //console.log(activeTab);
